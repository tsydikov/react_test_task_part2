...
function App() {
  ...
  console.log(workingIntervals[workingIntervals.length-1])
  return (
    <div className="App">
      <h1>[{workingIntervals.map(interval => (interval === workingIntervals[workingIntervals.length-1]) ? interval : (interval+', ')
         )}]</h1>
    </div>
  );
}
